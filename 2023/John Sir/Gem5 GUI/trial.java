...
public class trial extends JFrame implements ActionListener {
    ...
    public trial() {
        ...
        contentPane = new JPanel() 
        {
            ...
            protected void paintComponent(Graphics g) {
                ...
                try {
                    BufferedImage image = ImageIO.read(new File("background.png")); // Replace "background.jpg" with the path to your image file
        ...
        myButton1 = new JButton("Build GEM5");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        {
            int value = Integer.parseInt(tField1.getText());
            tField1.setText(Integer.toString(value + 1));
        }
    }
